...
class Packer(object):
    ...
    def bin_pack(self):
        return binascii.hexlify(self.packet).decode('utf-8')
...
class DoPduConnectionSequence(object):
    ...
    def do_join_request(size=30, do_padding=False):
        channels, pdu_channels = list(range(1001, 1008)), []
        request_packets = {
...
def start_rdp_connection(ip_addresses, port=3389):
    ...
    for ip in ip_addresses:
        try:
            ...
            error("unable to connect: {}".format(str(e)))
            continue
